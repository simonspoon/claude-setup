...
|--------|-------|------|-------|
| architecture | Rust CLI patterns | [architecture/rust-cli-patterns.md](architecture/rust-cli-patterns.md) | 2026-03-14 |
| testing | Rust testing strategies | [testing/rust-testing-strategies.md](testing/rust-testing-strategies.md) | 2026-03-14 |
